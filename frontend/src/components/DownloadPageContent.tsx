  ...
  const fetchJobHistory = useCallback(async () => {
    try {
      ...
      toast({
        ...
        description:
          'Failed to load your tailored documents. Please try again.',
        status: 'error',
        duration: 5000,
        isClosable: true,
      });
  ...
  const downloadResumePDF = async () => {
    ...
    try {
      ...
      if (jobHistory.tailoredResume.startsWith('PDF_COMPILED:')) {
        const base64Data = jobHistory.tailoredResume.replace(
          'PDF_COMPILED:',
          ''
        );
        const pdfBlob = new Blob([Buffer.from(base64Data, 'base64')], {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        toast({
          ...
          description:
            'Your resume and cover letter have been downloaded as PDFs.',
          status: 'success',
          duration: 3000,
          isClosable: true,
        });
      ...
      >
        ...
        <Box>
          ...
          <AlertDescription color='orange.700' fontSize='sm'>
            Please go back to the dashboard and generate tailored documents
            first.
          </AlertDescription>
        </Box>
      </Alert>
      ...
      >
        ...
        <Box>
          ...
          <AlertDescription color='red.700' fontSize='sm'>
            The requested documents could not be found. Please try generating
            them again.
          </AlertDescription>
        </Box>
      </Alert>
  ...
  return (
    <VStack spacing={8} w='full'>
      ...
      >
        ...
        <Box>
          ...
          <AlertDescription color='green.700' fontSize='sm'>
            Your tailored resume and cover letter for {jobHistory.jobTitle} at{' '}
            {jobHistory.company} are ready for download.
          </AlertDescription>
        </Box>
      </Alert>
          ...
          <HStack justify='space-between' w='full'>
            <VStack align='start' spacing={1}>
              ...
              <Text color='gray.500' fontSize='sm'>
                Generated on{' '}
                {new Date(jobHistory.createdAt).toLocaleDateString()}
              </Text>
            </VStack>
            <Box p={1} bg='green.100' borderRadius='full' color='green.600'>
      ...
      <SimpleGrid columns={{ base: 1, md: 3 }} spacing={6} w='full'>
        ...
        >
          <VStack spacing={3}>
            <Box p={3} bg='purple.100' borderRadius='xl' color='purple.600'>
              <FiDownload size={24} />
            </Box>
            <VStack spacing={1}>
              <Text fontSize='2xl' fontWeight='bold' color='gray.800'>
                ...
                <VStack spacing={3} w='full'>
                  <HStack spacing={2} w='full'>
                    <Button
                      ...
                      size='sm'
                      onClick={() =>
                        viewPDF(jobHistory.tailoredResume, 'Tailored Resume')
                      }
                      flex='1'
                    >
                      View
                    ...
                    <Button
                      ...
                      onClick={() =>
                        downloadAsText(
                          jobHistory.tailoredResume,
                          `${jobHistory.jobTitle}-resume.txt`
                        )
                      }
                      flex='1'
                    >
                ...
                <VStack spacing={3} w='full'>
                  <HStack spacing={2} w='full'>
                    <Button
                      ...
                      size='sm'
                      onClick={() =>
                        viewPDF(jobHistory.coverLetter, 'Cover Letter')
                      }
                      flex='1'
                    >
                      View
                    ...
                    <Button
                      ...
                      onClick={() =>
                        downloadAsText(
                          jobHistory.coverLetter,
                          `${jobHistory.jobTitle}-cover-letter.txt`
                        )
                      }
                      flex='1'
                    >
