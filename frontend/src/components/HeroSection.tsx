          ...
          <VStack spacing={6} className='slide-in-left'>
            ...
            >
              ...
              <Text
                ...
                sx={{
                  background:
                    'linear-gradient(135deg, #0088ff 0%, #005899 100%)',
                  backgroundClip: 'text',
                  WebkitBackgroundClip: 'text',
                  WebkitTextFillColor: 'transparent',
                  '&::after': {
            ...
            >
              ...
              Upload your resume, enter any job description, and get a perfectly
              tailored resume and cover letter in minutes. Save hours of work
              and dramatically increase your chances of landing your dream job.
            </Text>
          </VStack>
