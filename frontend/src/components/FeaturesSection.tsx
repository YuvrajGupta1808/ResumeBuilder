        ...
        <VStack spacing={20}>
          ...
          <VStack spacing={8} textAlign="center" maxW="5xl" className="fade-in">
            ...
            <Heading
              ...
              sx={{
                background: 'linear-gradient(135deg, #1a202c 0%, #0088ff 60%, #005899 100%)',
                backgroundClip: 'text',
            ...
            {features.map((feature, index) => (
              <Box
                ...
                sx={{
                  ...
                  '&:hover': {
                    ...
                    borderColor: `rgba(${feature.color === 'blue' ? '0, 136, 255' :
                                      feature.color === 'green' ? '34, 197, 94' :
                                      feature.color === 'purple' ? '147, 51, 234' :
                                      feature.color === 'orange' ? '245, 158, 11' :
                  ...
                  '&::before': {
                    ...
                    right: 0,
                    bottom: 0,
                    background: `linear-gradient(135deg, rgba(${feature.color === 'blue' ? '0, 136, 255' :
                                                            feature.color === 'green' ? '34, 197, 94' :
                                                            feature.color === 'purple' ? '147, 51, 234' :
                                                            feature.color === 'orange' ? '245, 158, 11' :
                                                            feature.color === 'red' ? '239, 68, 68' :
                                                            '20, 184, 166'}, 0.05) 0%, transparent 70%)`,
                    borderRadius: '24px',
                    opacity: 0,
              ...
              >
                ...
                <Box
                  ...
                  boxShadow={`0 4px 8px rgba(${feature.color === 'blue' ? '0, 136, 255' :
                                             feature.color === 'green' ? '34, 197, 94' :
                                             feature.color === 'purple' ? '147, 51, 234' :
                                             feature.color === 'orange' ? '245, 158, 11' :
                                             feature.color === 'red' ? '239, 68, 68' :
                ...
                <VStack spacing={8} align="start" textAlign="left">
                  ...
                  <HStack spacing={5} align="center">
                    <Box
                      ...
                      border="2px"
                      borderColor={`${feature.color}.300`}
                      boxShadow={`0 8px 16px rgba(${feature.color === 'blue' ? '0, 136, 255' :
                                                   feature.color === 'green' ? '34, 197, 94' :
                                                   feature.color === 'purple' ? '147, 51, 234' :
                                                   feature.color === 'orange' ? '245, 158, 11' :
                                                   feature.color === 'red' ? '239, 68, 68' :
                      ...
                      sx={{
                        ...
                        '.chakra-card:hover &': {
                          ...
                          boxShadow: `0 12px 24px rgba(${feature.color === 'blue' ? '0, 136, 255' :
                                                         feature.color === 'green' ? '34, 197, 94' :
                                                         feature.color === 'purple' ? '147, 51, 234' :
                                                         feature.color === 'orange' ? '245, 158, 11' :
                                                         feature.color === 'red' ? '239, 68, 68' :
                    ...
                    <Badge
                      ...
                      sx={{
                        ...
                        '.chakra-card:hover &': {
                          ...
                          boxShadow: `0 6px 12px rgba(${feature.color === 'blue' ? '0, 136, 255' :
                                                         feature.color === 'green' ? '34, 197, 94' :
                                                         feature.color === 'purple' ? '147, 51, 234' :
                                                         feature.color === 'orange' ? '245, 158, 11' :
                                                         feature.color === 'red' ? '239, 68, 68' :
