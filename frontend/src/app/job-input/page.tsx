                    ...
                    <HStack spacing={4} align='center'>
                      ...
                      <VStack align='start' spacing={2}>
                        <Heading
                          ...
                          sx={{
                            background:
                              'linear-gradient(135deg, #1a202c 0%, #9333ea 70%, #7c3aed 100%)',
                            backgroundClip: 'text',
                        ...
                        <Text
                          ...
                          lineHeight='1.6'
                        >
                          Enter the job description to tailor your resume and
              ...
              >
                ...
                <Box>
                  ...
                  <AlertDescription
                    ...
                    fontWeight='500'
                  >
                    The more detailed the job description, the better our AI can
                    tailor your resume and cover letter to match the
                    requirements.
                  </AlertDescription>
                </Box>
              </Alert>
                  ...
                  <VStack spacing={5}>
                    ...
                    <VStack spacing={3}>
                      ...
                      <Text
                        ...
                        lineHeight='1.6'
                      >
                        AI analyzes job requirements and matches them with your
                        skills
                      </Text>
                    </VStack>
                  </VStack>
                  ...
                  <VStack spacing={5}>
                    ...
                    <VStack spacing={3}>
                      ...
                      <Text
                        ...
                        lineHeight='1.6'
                      >
                        Generate a compelling cover letter that complements your
                        resume
                      </Text>
                    </VStack>
                  </VStack>
